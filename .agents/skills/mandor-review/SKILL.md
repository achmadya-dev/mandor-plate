...
The issue tracker should have been provided to you — run `/mandor-setup` if `docs/agents/issue-tracker.md` is missing.
...
3. A PRD/spec file under `docs/`, `specs/`, or another local planning-doc location matching the branch name or feature.
